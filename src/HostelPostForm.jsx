...
export default function HostelPostForm({makePost, postData, user}) {
    ...
    return (
        <div>
            ...
            <input placeholder="Any additional comments ?" type="text" name="additional_comment" value={newPost.additional_comment} onChange={handleChange} />
            <input placeholder="Country" type="text" name="country" value={newPost.country} onChange={handleChange} />
            <input placeholder="0/100" type="number" name="rating" value={newPost.rating} onChange={handleChange} />
